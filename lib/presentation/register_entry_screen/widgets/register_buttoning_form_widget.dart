...
class RegisterButtoningFormWidget extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  final void Function(Map<String, dynamic> data) onSave;

  const RegisterButtoningFormWidget({
  ...
  @override
  State<RegisterButtoningFormWidget> createState() =>
      _RegisterButtoningFormWidgetState();
}

class _RegisterButtoningFormWidgetState
    extends State<RegisterButtoningFormWidget> {
  ...
  String _selectedOperation = 'Buttoning';
  static const List<String> _operations = ['Buttoning', 'Button Holing'];
  ...
  void initState() {
    ...
    if (d != null) {
      ...
      _quantityCtrl.text = '${d['quantity'] ?? ''}';
      _representativeCtrl.text = d['representative'] ?? '';
      _remarksCtrl.text = d['remarks'] ?? '';
      _selectedOperation = d['operation'] ?? 'Buttoning';
  ...
  Future<String?> _uploadPhoto() async {
    ...
    try {
      ...
      final fileName = 'buttoning_${ISTUtils.now().millisecondsSinceEpoch}.jpg';
      final filePath = 'buttoning/$fileName';
      if (kIsWeb) {
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: _operations
                  ...
                  .toList(),
              onChanged: (val) => setState(() => _selectedOperation = val!),
              validator: (v) => v == null || v.isEmpty ? 'Required' : null,
            ),
            const SizedBox(height: 10),
            _buildField(
            ...
            ElevatedButton.icon(
              ...
              label: Text(
                widget.initialData != null ? 'Update Entry' : 'Save Entry',
              ),
