...
class RegisterDailyProductionFormWidget extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  final void Function(Map<String, dynamic> data) onSave;

  const RegisterDailyProductionFormWidget({
  ...
  @override
  State<RegisterDailyProductionFormWidget> createState() =>
      _RegisterDailyProductionFormWidgetState();
}

class _RegisterDailyProductionFormWidgetState
    extends State<RegisterDailyProductionFormWidget> {
  ...
  Future<String?> _uploadPhoto() async {
    ...
    try {
      ...
      final fileName =
          'daily_prod_${ISTUtils.now().millisecondsSinceEpoch}.jpg';
      final filePath = 'daily-production/$fileName';
      if (kIsWeb) {
                ...
                child: _pickedPhoto != null
                    ? (kIsWeb
                          ? Image.network(
                              _pickedPhoto!.path,
                              fit: BoxFit.cover,
                              semanticLabel: 'Production photo',
                            )
                          : Image.file(
                              File(_pickedPhoto!.path),
                              fit: BoxFit.cover,
  ...
  Widget _buildField(
    ...
    return TextFormField(
      ...
      decoration: _inputDecoration(label, null, hint: hint),
      validator: validator,
    );
  }
